<?php
/**
 * storex functions and definitions.
 *
...
function storex_setup() {
	 ...
	 * If you're building a theme based on storex, use a find and replace
	 * to change 'storex' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'storex' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'storex_custom_background_args', array(
 ...
 */
function storex_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'storex_content_width', 640 );
}
add_action( 'after_setup_theme', 'storex_content_width', 0 );
...
function storex_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'storex' ),
		'id'            => 'sidebar-1',
		'description'   => '',
